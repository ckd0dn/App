...
public class Pop_recipe10_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_recipe10);

        recyclerView = findViewById(R.id.pop_recipe_recyclerview10); // 아이디 연결
        ...
        databaseReference.child("밥_죽_떡").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        adapter = new CustomAdapter10(arrayList1,this);
