...
public class CustomAdapter8 extends RecyclerView.Adapter<CustomAdapter8.CustomViewHolder> {

    private ArrayList<Recipe> arrayList1;
    private Context context;


    public CustomAdapter8(ArrayList<Recipe> arrayList1, Context context ) {
