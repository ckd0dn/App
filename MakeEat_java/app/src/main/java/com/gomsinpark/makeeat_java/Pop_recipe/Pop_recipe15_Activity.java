...
public class Pop_recipe15_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_recipe15);

        recyclerView = findViewById(R.id.pop_recipe_recyclerview15); // 아이디 연결
        ...
        databaseReference.child("차_음료_술").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        adapter = new CustomAdapter15(arrayList1,this);
