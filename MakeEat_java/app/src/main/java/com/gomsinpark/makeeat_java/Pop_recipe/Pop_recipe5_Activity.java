...
public class Pop_recipe5_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_recipe5);

        recyclerView = findViewById(R.id.pop_recipe_recyclerview5); // 아이디 연결
        ...
        databaseReference.child("국탕").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        adapter = new CustomAdapter5(arrayList1,this);
