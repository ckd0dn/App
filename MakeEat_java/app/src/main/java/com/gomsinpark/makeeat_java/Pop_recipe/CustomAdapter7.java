...
public class CustomAdapter7 extends RecyclerView.Adapter<CustomAdapter7.CustomViewHolder> {

    private ArrayList<Recipe> arrayList1;
    private Context context;


    public CustomAdapter7(ArrayList<Recipe> arrayList1, Context context ) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (pos != RecyclerView.NO_POSITION) {
                        ...
                        intent.putExtra("cooking_time", arrayList1.get(pos).getCooking_time());
                        intent.putExtra("chef", arrayList1.get(pos).getChef());
                        intent.putExtra("views", arrayList1.get(pos).getViews());
                        intent.putExtra("rank", String.valueOf(arrayList1.get(pos).getRank()));
