...
public class Pop_recipe4_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_recipe4);

        recyclerView = findViewById(R.id.pop_recipe_recyclerview4); // 아이디 연결
        ...
        databaseReference.child("퓨전").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        adapter = new CustomAdapter4(arrayList1,this);
