...
public class Pop_recipe7_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_recipe7);

        recyclerView = findViewById(R.id.pop_recipe_recyclerview7); // 아이디 연결
        ...
        databaseReference.child("면_만두").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        adapter = new CustomAdapter7(arrayList1,this);
