...
public class CustomAdapter10 extends RecyclerView.Adapter<CustomAdapter10.CustomViewHolder> {

    private ArrayList<Recipe> arrayList1;
    private Context context;


    public CustomAdapter10(ArrayList<Recipe> arrayList1, Context context ) {
