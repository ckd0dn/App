...
public class Pop_recipe3_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_recipe3);

        recyclerView = findViewById(R.id.pop_recipe_recyclerview3); // 아이디 연결
        ...
        databaseReference.child("양식").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        adapter = new CustomAdapter3(arrayList1,this);
