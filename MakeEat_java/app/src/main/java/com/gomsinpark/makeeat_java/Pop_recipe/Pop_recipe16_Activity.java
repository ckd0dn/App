...
public class Pop_recipe16_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_recipe16);

        recyclerView = findViewById(R.id.pop_recipe_recyclerview16); // 아이디 연결
        ...
        databaseReference.child("양념_소스_잼").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        adapter = new CustomAdapter16(arrayList1,this);
