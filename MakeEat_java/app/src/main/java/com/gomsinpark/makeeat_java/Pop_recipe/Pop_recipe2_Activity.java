...
public class Pop_recipe2_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_recipe2);

        recyclerView = findViewById(R.id.pop_recipe_recyclerview2); // 아이디 연결
        ...
        databaseReference.child("밑반찬").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        adapter = new CustomAdapter2(arrayList1,this);
