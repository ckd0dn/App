...
public class Pop_recipe13_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_recipe13);

        recyclerView = findViewById(R.id.pop_recipe_recyclerview13); // 아이디 연결
        ...
        databaseReference.child("디저트").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        adapter = new CustomAdapter13(arrayList1,this);
