...
public class Pop_recipe12_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_recipe12);

        recyclerView = findViewById(R.id.pop_recipe_recyclerview12); // 아이디 연결
        ...
        databaseReference.child("스프").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        adapter = new CustomAdapter12(arrayList1,this);
