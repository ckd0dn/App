...
public class Pop_recipe8_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_recipe8);

        recyclerView = findViewById(R.id.pop_recipe_recyclerview8); // 아이디 연결
        ...
        databaseReference.child("김치_젓갈_장류").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        adapter = new CustomAdapter8(arrayList1,this);
