...
public class Pop_recipe14_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_recipe14);

        recyclerView = findViewById(R.id.pop_recipe_recyclerview14); // 아이디 연결
        ...
        databaseReference.child("과자").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        adapter = new CustomAdapter14(arrayList1,this);
