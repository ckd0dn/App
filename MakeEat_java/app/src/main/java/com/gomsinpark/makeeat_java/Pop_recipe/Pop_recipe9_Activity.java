...
public class Pop_recipe9_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_recipe9);

        recyclerView = findViewById(R.id.pop_recipe_recyclerview9); // 아이디 연결
        ...
        databaseReference.child("샐러드").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        adapter = new CustomAdapter9(arrayList1,this);
