...
public class Pop_recipe17_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_recipe17);

        recyclerView = findViewById(R.id.pop_recipe_recyclerview17); // 아이디 연결
        ...
        databaseReference.child("기타").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        adapter = new CustomAdapter17(arrayList1,this);
