...
public class Pop_recipe11_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_recipe11);

        recyclerView = findViewById(R.id.pop_recipe_recyclerview11); // 아이디 연결
        ...
        databaseReference.child("빵").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        adapter = new CustomAdapter11(arrayList1,this);
