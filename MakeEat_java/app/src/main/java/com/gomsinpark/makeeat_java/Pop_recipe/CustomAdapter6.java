...
public class CustomAdapter6 extends RecyclerView.Adapter<CustomAdapter6.CustomViewHolder> {

    private ArrayList<Recipe> arrayList1;
    private Context context;


    public CustomAdapter6(ArrayList<Recipe> arrayList1, Context context ) {
