...
public class CustomAdapter5 extends RecyclerView.Adapter<CustomAdapter5.CustomViewHolder> {

    private ArrayList<Recipe> arrayList1;
    private Context context;


    public CustomAdapter5(ArrayList<Recipe> arrayList1, Context context ) {
