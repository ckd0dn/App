...
public class CustomAdapter13 extends RecyclerView.Adapter<CustomAdapter13.CustomViewHolder> {

    private ArrayList<Recipe> arrayList1;
    private Context context;


    public CustomAdapter13(ArrayList<Recipe> arrayList1, Context context ) {
