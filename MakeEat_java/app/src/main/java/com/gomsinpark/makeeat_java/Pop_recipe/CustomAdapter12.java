...
public class CustomAdapter12 extends RecyclerView.Adapter<CustomAdapter12.CustomViewHolder> {

    private ArrayList<Recipe> arrayList1;
    private Context context;


    public CustomAdapter12(ArrayList<Recipe> arrayList1, Context context ) {
