...
public class Pop_recipe1_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_recipe1);

        recyclerView = findViewById(R.id.pop_recipe_recyclerview); // 아이디 연결
        ...
        databaseReference.child("메인반찬").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        adapter = new CustomAdapter1(arrayList1,this);
