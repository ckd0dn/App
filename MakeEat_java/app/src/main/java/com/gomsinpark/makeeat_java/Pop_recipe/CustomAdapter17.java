...
public class CustomAdapter17 extends RecyclerView.Adapter<CustomAdapter17.CustomViewHolder> {

    private ArrayList<Recipe> arrayList1;
    private Context context;


    public CustomAdapter17(ArrayList<Recipe> arrayList1, Context context ) {
