...
public class CustomAdapter15 extends RecyclerView.Adapter<CustomAdapter15.CustomViewHolder> {

    private ArrayList<Recipe> arrayList1;
    private Context context;


    public CustomAdapter15(ArrayList<Recipe> arrayList1, Context context ) {
