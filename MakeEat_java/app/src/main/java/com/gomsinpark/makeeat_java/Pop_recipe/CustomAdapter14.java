...
public class CustomAdapter14 extends RecyclerView.Adapter<CustomAdapter14.CustomViewHolder> {

    private ArrayList<Recipe> arrayList1;
    private Context context;


    public CustomAdapter14(ArrayList<Recipe> arrayList1, Context context ) {
