...
public class CustomAdapter11 extends RecyclerView.Adapter<CustomAdapter11.CustomViewHolder> {

    private ArrayList<Recipe> arrayList1;
    private Context context;


    public CustomAdapter11(ArrayList<Recipe> arrayList1, Context context ) {
