...
public class CustomAdapter16 extends RecyclerView.Adapter<CustomAdapter16.CustomViewHolder> {

    private ArrayList<Recipe> arrayList1;
    private Context context;


    public CustomAdapter16(ArrayList<Recipe> arrayList1, Context context ) {
